...
def get_dynamic_system_instruction(config: dict[str, Any]) -> str:
    ...
    guidelines = [
        ...
        "9. Use 'memory_store' when the user explicitly asks you to remember something (e.g. 'remember that', 'save this', 'keep in mind') or states important personal facts, preferences, credentials, or persistent configuration details that would be useful to keep for future sessions. Extract the key fact as 'text' and infer a short 'topic' label.",
        "10. Use 'memory_recall' when the user asks about previously shared details (e.g. 'do you remember', 'what do you know about', 'recall') or asks questions about their personal preferences, custom settings, server ports, or project setups that you do not have in your immediate context. Set 'query' to the topic they are asking about.",
